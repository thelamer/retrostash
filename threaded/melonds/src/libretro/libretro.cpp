  ...
  static const retro_variable values[] =
   {
      ...
      { "melonds_screen_layout", "Screen Layout; Left/Right|Top/Bottom|Bottom/Top|Right/Left|Top Only|Bottom Only|Hybrid Top|Hybrid Bottom" },
...
#ifdef HAVE_THREADS
      { "melonds_threaded_renderer", "Threaded software renderer; enabled|disabled" },
#endif
      { "melonds_touch_mode", "Touch mode; Joystick|disabled|Mouse|Touch" },
#ifdef HAVE_OPENGL
